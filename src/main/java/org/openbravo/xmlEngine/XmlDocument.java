...
public class XmlDocument implements XmlComponentValue {
    ...
    /**
     * Translates the template for sections within DataValue. Note that
     * subsections are in DataValue and are not translated in with the general
     * template
     *
     * @param elementDataValue DataValue object that might contain sections to
     * be translated
     */
