 ...
 * defined is using return="scrollable"
 *
 * Generated classes implementing this allow reading the result row by row
 * without the need to load all the potentially big dataset all at once into
 * memory.
 *
 * @author huehner
 *
