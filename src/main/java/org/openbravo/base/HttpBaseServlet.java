...
public class HttpBaseServlet extends HttpServlet implements ConnectionProvider {
     ...
     *
     * @param request HttpServletRequest object where details of the HTTP
     * request are.
     * @param response HttpServletResponse object where the response will be
     * written and returned to the user.
     * @throws IOException
     ...
     *
     * @param language String specifying the language folder required, e.g.
     * es_ES
     ...
     *
     * @param conn The Connection object required to be committed and stored
     * back into the pool.
     * @throws SQLException
     */
     ...
     * pool of available connections managed by this class.
     *
     * @param conn The Connection object required to be rolled back and stored
     * back into the pool.
     * @throws SQLException
     */
     ...
     * @param out OutputStream object to which the PDF will be rendered to.
     * @throws ServletException
     */
    ...
    /**
     * Renders a PDF directly into a HttpServletResponse. <b>NOTE:</b> If you
     * use this method the 'loading' pop-up window will not be closed.
     *
     * @throws ServletException
     */
