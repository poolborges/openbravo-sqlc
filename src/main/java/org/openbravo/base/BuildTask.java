...
/**
 * This class starts a build of Openbravo. It is designed to be called from the
 * application itself (via the Module Management Console). The kind of build
 * which is started is decided by the status of the system database.
 */
public class BuildTask {
    ...
    /**
     * This class starts a build of Openbravo. The kind of build is decided by
     * this class logic
     */
